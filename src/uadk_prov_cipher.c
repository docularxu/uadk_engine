			       ...
			       const unsigned char *in, size_t inlen)
{
	...
	return 1;
sync_err:
	if (!uadk_prov_cipher_soft_work(priv, out, in, inlen))
...
const OSSL_DISPATCH uadk_##nm##_functions[] = {                              	\
    ...
    { OSSL_FUNC_CIPHER_ENCRYPT_INIT, (void (*)(void))uadk_prov_cipher_einit },	\
    { OSSL_FUNC_CIPHER_DECRYPT_INIT, (void (*)(void))uadk_prov_cipher_dinit },	\
